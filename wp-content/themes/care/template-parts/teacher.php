...
<section id="daycare-center" class="daycare-center"> 
  ...
  <div id="bg-3-1" class="commen-bg-style" style="background-image: url(<?php the_field('fetures_teacher_background_image'); ?>);"> </div>
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <div class="get-app-containt-area left-bg">
          <div class="download-first-part">
            <h2><?php the_field('teacher_page_title'); ?></h2>
            <hr class="yellow-hr-2px">
            <p><?php the_Field('teacher_page_description'); ?></p>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12 center-button">
        <button type="button" class="rounded-getnow-btn " style="background-color: <?php the_field('teachers_graphical_button_background_color'); ?>;"><?php the_field('teachers_graphical_button_title'); ?><i class="fa <?php the_field('teachers_graphical_button_icon'); ?>" aria-hidden="true"></i></button>
<!--    ### Learn More Button    
        <button type="button" class="rounded-learnmore-btn "><?php //the_field('teachers_plain_button_title'); ?></button>-->
      </div>
    </div>
    <div class="row for-parent-section">
      <div class="col-xs-12">
        <div class="section-title text-center">
          <h2><?php the_Field('teacher_feature_title'); ?></h2>
        </div>
      </div>
      <div class="row">
        <?php 
            if(have_rows('features_teacher')):
                while (have_rows('features_teacher')):
                    the_row(); ?>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class=" features-parents-mid-section">
            <div class="bulb-center">
              <div class="border-icon"> <span class="<?php the_sub_field('features_teacher_icon'); ?>"></span> </div>
            </div>
            <div class="feature-text-center">
              <h5><?php the_sub_field('teacher_name'); ?>:</h5>
              <p><?php the_sub_field('teacher_discription'); ?></p>
            </div>
          </div>
        </div>
        <?php endwhile;
...
<section class="simple-interface-slider">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title text-center">
          <h2><?php the_field('teacher_simple_interface'); ?></h2>
          <hr class="yellow-hr-2px">
        </div>
      </div>
    </div>
  ...
  <div class="simple-interface-slider">
    <div class="screen-shold tablet-shold">
      <div class="screen-slider">
          <?php
            if(have_rows('interface_images')):
                while (have_rows('interface_images')):
                    the_row();
          ?>
        <div class="slide"> <img src="<?php the_sub_field('interface_image'); ?>" alt="images" class="img-responsive"> </div>
        <?php
            endwhile;
        endif;
        ?>
      </div>
      <div class="cover tablet"> <img src="<?php the_Field('interface_cover_images'); ?>" alt="images" class="img-responsive"> </div>
    </div>
  </div>
  </div>
</section>
